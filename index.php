...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="banquet.php">Soiree</a></li>
		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Mrizi Restaurant</strong></h1>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Yajman Restaurant & Banquet</span></h1>
						<p>Yajman Restauarant is a bench mark for Taste & Hygiene. We offer best quality food with premium services. Trending Takeaway service is also available here. Yajman Banquet is perfect location for all your functions. Now book your banquet online and celebrate the function offline!</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">Yajman Restaurant & Banquet</span>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- Start Services -->
	<div id="services">
		<div class="container-fluid p-5" style="background-color:#dcdcdc; border-top:3px solid #db9fd7; border-bottom:3px solid #db9fd7;;">
			<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Our Services </h2>
						<h2 style="color : #db9fd7;">Takeaway Orders & Banquet Hall</h2>
					</div>
				</div>
			</div>
